...
function showParisAttractions() {
    ...
    const attractions = [
        { name: "1. Eiffel Tower", description: "The iconic iron lattice tower on the Champ de Mars, built in 1889. It's one of the world's most recognizable landmarks and offers breathtaking views of Paris.<br>This attraction varies in price between Adults, Youth and Children<br>Adult prices: Second floor by stairs: £14.20 (≈ $16)<br>    Second floor with Lift: £22.60 (≈ $25) <br>     Top floor with Lift: £25.30 (≈ $28) <br> Youth (12-24 yrs old) and child (4-11 yrs old)price vary.", image: "images/paris/EiffelTower.png" },
